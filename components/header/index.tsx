                ...
                <div className="flex h-16 items-center justify-between gap-4">
                                        ...
                                        return (
                                            <NavigationMenuItem key={title} data-submenu-len={submenuItems.length}>
                                                ...
                                                <NavigationMenuContent className="p-3">
                                                    <div className={`max-w-screen w-150 grid gap-1 grid-flow-col grid-rows-3 grid-cols-${submenuItems.length / 3}`} data-submenu-items={submenuItems.length} >
                    ...
                    <div className="flex items-center justify-center gap-3 shrink-0">
                        ...
                        <Sheet open={open} onOpenChange={setOpen}>
                            ...
                            <SheetContent side="right" className="w-75 sm:w-100 focus:ring-0 focus:ring-transparent focus:ring-offset-0">

...
import people from "@/app/public/images/how-to-start.jpg"
        ...
        <div className="flex flex-col lg:flex-row gap-y-2 items-center">
            ...
            <div className="lg:basis-1/2 px-4">
                ...
                <p className="text-md leading-relaxed text-muted-foreground my-6">
                    Ogni anno il CAP per mezzo delle Associazioni locali o rganizza una serie di CORSI formativi per i costruttori o per coloro che vogliono toccare con mano le varie tecniche che coinvolgono la costruzione aeronautica. I corsi vengono tenuti da soci esperti costruttori e gli argomenti toccano tutti gli argomenti necessari per la buona riuscita di un progetto.
                </p>
                <p className="text-md leading-relaxed text-muted-foreground my-6">

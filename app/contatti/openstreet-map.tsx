...
const coordinates: LatLngExpression = [45.541457, 9.19622]
...
const OpenStreetMap = () => {
    ...
    useEffect(() => {
        ...
        const initMap = async () => {
            ...
            mapInstance = L.map(mapRef.current as HTMLDivElement, {
                center: coordinates,
                zoom: 16,
            })
            ...
            L.marker(coordinates, { icon }).addTo(mapInstance).bindPopup(popupMessage)
        }

...
import { Users, MapPin, Plane, GraduationCap, ClockFading, Globe, CalendarClock } from "lucide-react"
    ...
    return (
        <>
            ...
            <div className="p-8 flex flex-col gap-y-8 max-w-7xl m-auto">
                <PageTitle title={content_title} description={description} icon="map-pin-house" />

                <section className="grid gap-4 grid-cols-[repeat(auto-fit,minmax(360px,480px))] justify-center">
